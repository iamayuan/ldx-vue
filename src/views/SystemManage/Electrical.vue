    ...
    <div class="electrical-header">
        <el-form ref="form" :model="electricalForm" >
          <el-form-item label="姓名" class="w50">
            <el-input placeholder="请输入推广人员姓名"  class="displayiB w70" v-model="electricalForm.name"></el-input>
          </el-form-item>
          <el-form-item label="机构" class="w50">
            <el-input placeholder="请输入推广人员所在机构"  class="displayiB w70" v-model="electricalForm.organization"></el-input>
          </el-form-item>
          <el-form-item label="手机号" class="w50">
            <el-input placeholder="请输入推广人员手机号"  class="displayiB w70" v-model="electricalForm.mobile"></el-input>
          </el-form-item>
          <el-form-item label="状态"  class="w50">
                <el-select placeholder="正式员工" class="electrical-select" v-model="electricalForm.status">
                    <el-option label="正式员工" value="0" class="displayB"></el-option>
...
import { getelectricalList } from '../../api/api';
