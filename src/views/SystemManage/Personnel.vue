    ...
    <div class="person-header">
        <el-form ref="form" :model="personForm" >
          <el-form-item label="姓名" class="w50">
            <el-input placeholder="请输入工作人员姓名"  class="displayiB w70" v-model="personForm.name"></el-input>
          </el-form-item>
          <el-form-item label="工号" class="w50">
            <el-input placeholder="请输入工作人员工号"  class="displayiB w70" v-model="personForm.id"></el-input>
          </el-form-item>
          <el-form-item label="状态" >
                <el-select placeholder="正式员工" class="person-select" v-model="personForm.status">
