  ...
  <section class="activity">
    <div class="activity-header">
        <el-form ref="form" :model="activityForm" >
            ...
            <el-input placeholder="输入活动标题"  class="displayiB w70" v-model="activityForm.title"></el-input>
          </el-form-item>
          <el-form-item label="活动状态" class="w50">
            <el-select placeholder="未开始" class="wechat-select" v-model="activityForm.status">
          ...
          <el-form-item label="开始时间" class="w50">
              <el-date-picker v-model="activityForm.startTime"  type="daterange" placeholder="选择日期"></el-date-picker>
          </el-form-item>
          <el-form-item label="结束时间" class="w50">
              <el-date-picker v-model="activityForm.endTime"  type="daterange" placeholder="选择日期"></el-date-picker>
          </el-form-item>
