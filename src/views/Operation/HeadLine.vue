  ...
  <section class="headline">
    <div class="headline-header">
        <el-form ref="form" :model="headlineForm" >
            ...
            <el-input placeholder="输入电力头条标题"  class="displayiB w70" v-model="headlineForm.title"></el-input>
          </el-form-item>
          <el-form-item label="状态" class="w50">
            <el-select placeholder="未发布" class="wechat-select" v-model="headlineForm.status">
