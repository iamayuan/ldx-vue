  ...
  <section class="help">
    <div class="help-header">
        <el-form ref="form" :model="helpForm" >
            ...
            <el-input placeholder="输入使用帮助标题"  class="displayiB w70" v-model="helpForm.title"></el-input>
          </el-form-item>
          <el-form-item label="状态" class="w50">
            <el-select placeholder="未发布" class="wechat-select" v-model="helpForm.status">
                <el-option label="未发布" value="0" class="displayB"></el-option>
                <el-option label="已发布" value="1" class="displayB"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="所属大类" class="w50">
            <el-select placeholder="业务指南" class="wechat-select" v-model="helpForm.cate">
                <el-option label="业务指南" value="0" class="displayB"></el-option>
                <el-option label="已发布" value="1" class="displayB"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="所属小类" class="w50">
            <el-select placeholder="业务报装" class="wechat-select" v-model="helpForm.sclass">
                <el-option label="业务报装" value="0" class="displayB"></el-option>
                <el-option label="已发布" value="1" class="displayB"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item>
